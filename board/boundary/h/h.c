...
#define NEW_PAD_CTRL(a, pad_ctrl) ((a & ~MUX_PAD_CTRL_MASK) | MUX_PAD_CTRL(pad_ctrl))
...
iomux_v3_cfg_t const usdhc4_pads[] = {
	...
	NEW_PAD_CTRL(MX6_PAD_SD4_DAT4__USDHC4_DAT4, USDHC_PAD_CTRL),
	NEW_PAD_CTRL(MX6_PAD_SD4_DAT5__USDHC4_DAT5, USDHC_PAD_CTRL),
	NEW_PAD_CTRL(MX6_PAD_SD4_DAT6__USDHC4_DAT6, USDHC_PAD_CTRL),
	NEW_PAD_CTRL(MX6_PAD_SD4_DAT7__USDHC4_DAT7, USDHC_PAD_CTRL),
	NEW_PAD_CTRL(MX6_PAD_NANDF_D5__GPIO_2_5, NO_PAD_CTRL), /* RESET */
};
...
iomux_v3_cfg_t const enet_pads1[] = {
	...
	/* pin 42 PHY nRST */
	NEW_PAD_CTRL(MX6_PAD_EIM_D23__GPIO_3_23, NO_PAD_CTRL),
...
iomux_v3_cfg_t const wl12xx_pads[] = {
	NEW_PAD_CTRL(MX6_PAD_NANDF_CS1__GPIO_6_14, WEAK_PULLDOWN),
	NEW_PAD_CTRL(MX6_PAD_NANDF_CS2__GPIO_6_15, OUTPUT_40OHM),
	NEW_PAD_CTRL(MX6_PAD_NANDF_CS3__GPIO_6_16, OUTPUT_40OHM),
};
...
iomux_v3_cfg_t const usb_pads[] = {
	NEW_PAD_CTRL(MX6_PAD_GPIO_17__GPIO_7_12, NO_PAD_CTRL),
};
...
static void enable_rgb(struct display_info_t const *dev)
{
	...
	gpio_direction_output(RGB_BACKLIGHT_PWM, 1);
}
...
static void enable_lvds(struct display_info_t const *dev)
{
	...
	gpio_direction_output(LVDS0_BACKLIGHT_PWM, 1);
	gpio_direction_output(LVDS1_BACKLIGHT_PWM, 1);
}
...
static void setup_display(void)
{
	...
	gpio_direction_input(RGB_BACKLIGHT_PWM);
	gpio_direction_input(LVDS0_BACKLIGHT_PWM);
	gpio_direction_input(LVDS1_BACKLIGHT_PWM);
	gpio_direction_output(MX6_H_RGB_MIRROR_V, 0);
	gpio_direction_output(MX6_H_RGB_MIRROR_H, 1);

	gpio_direction_output(MX6_H_LVDS0_12V_5V_BL_SELECT, 0);
	gpio_direction_output(MX6_H_RGB_LVDS1_12V_5V_BL_SELECT, 0);
	gpio_direction_output(MX6_H_12V_POWER_EN, 0);
}
#endif
...
static iomux_v3_cfg_t const i2c0_mux_pads[] = {
	NEW_PAD_CTRL(MX6_PAD_EIM_D20__GPIO_3_20, I2C_PAD_CTRL), /* CAM */
	NEW_PAD_CTRL(MX6_PAD_EIM_CS0__GPIO_2_23, I2C_PAD_CTRL)   /* RTC */
};
